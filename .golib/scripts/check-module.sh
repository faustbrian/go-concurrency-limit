...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-concurrency-limit" &&
                "${module_path}" != github.com/faustbrian/go-concurrency-limit/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-concurrency-limit"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
